...
try:
    ...
    # Aq inverte o vetor da velociade angular (para sair fisicamente coerente no plot)
    signal = df_plot[COLUNA_VELOCIDADE_ANGULAR].values[::-1] #<---- erro bobo tava aqui
    ...
    #x.set_aspect('equal', adjustable='datalim')
    ax.set_aspect('auto')
    ax.minorticks_on()
    ...
    ax.set_title('Velocidade máxima vs |Amplitude|')
